...
test.describe('Test Box', () => {
  test.skip('Text Box form should submit data correctly', async ({ page }) => {
  ...
  test.skip('should not submit invalid email and no output appears', async ({ page }) => {
    await page.goto('https://demoqa.com/text-box');
  ...
  test.skip('Text Box - email validation state should update correctly', async ({ page }) => {
    await page.goto('https://demoqa.com/text-box');
